...
tell application "Mail"
  ...
  repeat with accountRef in accounts
    ...
    set end of accountRows to my jsonString(accountName)
  ...
  set accountText to accountRows as text
  set mailboxText to rows as text
  return "{\\\"accounts\\\":[" & accountText & "],\\\"mailboxes\\\":[" & mailboxText & "]}"
end tell`;
}
